...
RegisterNetEvent('desync-lib:validateCallback', function(callbackName, invokingResource, key)
...
exports('setValidCallback', lib.setValidCallback)
exports('isCallbackValid', lib.isCallbackValid)
