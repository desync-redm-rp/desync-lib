-- Some users have decided to load this file as part of desync-lib's fxmanifest?
...
local settings = {
    default_locale = GetConvar('desync:locale', 'en'),
...
local userLocales = GetConvarInt('desync:userLocales', 1) == 1
...
RegisterCommand('desync-lib', function()
    local inputSettings = {
        {
            type = 'checkbox',
        ...
        table.insert(inputSettings,
            {
                ...
                options = GlobalState['desync-lib:locales'],
