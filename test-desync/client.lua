...
-- Register command to toggle UI (for testing)
RegisterCommand('hud', function()
    ToggleUI()
end, false)

-- Key binding for F1 key (RedM compatible)
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
...
-- Event handlers
RegisterNetEvent('desync-lib:showUI')
AddEventHandler('desync-lib:showUI', function()
    ShowUI()
end)

RegisterNetEvent('desync-lib:hideUI')
AddEventHandler('desync-lib:hideUI', function()
    HideUI()
end)

RegisterNetEvent('desync-lib:toggleUI')
AddEventHandler('desync-lib:toggleUI', function()
    ToggleUI()
end)
